...
genoptglobconf gcglobdefaults {
	...
	{ wxT("48"), 1},
	{ wxT("40"), 1},
	{ wxT("uZB@unbzuvup - T - t - F - XiXrXtXfXdQF-r(' - Unread')NC"), 1},
	{ wxT("uZB@unbzuvup -> UZB@UnbzUvUp - T - t - F - XiXdQF-r(' - Unread')NC"), 1},
	{ wxT("rZB@rnbzrvrp 'RT by' uZB@unbzuvup - T - t - F - XiXrXtXfXdQF-r(' - Unread')Nc"), 1},
