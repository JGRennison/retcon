...
enum class LOGT : unsigned int {
	...
	GROUP_ALL          = CURLVERB | PARSE | PARSEERR | SOCKTRACE | SOCKERR | NETACT | DBTRACE | DBINFO | DBERR | ZLIBTRACE | ZLIBERR |
	                     ...
	                     FILEIOTRACE | FILEIOERR | NOTIFYEVT | TPANELTRACE | TPANELINFO | GLIB | VLCDEBUG | VLCERR,
	GROUP_STR          = GROUP_ALL,
	GROUP_ERR          = SOCKERR | DBERR | ZLIBERR | PARSEERR | OTHERERR | WXLOG | FILTERERR | FILEIOERR | VLCERR,
